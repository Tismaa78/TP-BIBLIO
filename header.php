...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-primary">
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false"><i class="fa-thin fa-flag"></i>  Gestion des nationalités</a>
        <div class="dropdown-menu">
          <a class="dropdown-item" href="listeNationnalite.php">Liste des nationalités</a>
